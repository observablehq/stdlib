...
export const vega = dependency("vega", "5.25.0", "build/vega.min.js");
export const vegalite = dependency("vega-lite", "5.9.3", "build/vega-lite.min.js");
export const vegaliteApi = dependency("vega-lite-api", "5.6.0", "build/vega-lite-api.min.js");
...
export const leaflet = dependency("leaflet", "1.9.4", "dist/leaflet.js");
