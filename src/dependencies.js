...
export const d3 = dependency("d3", "7.0.3", "dist/d3.min.js");
export const inputs = dependency("@observablehq/inputs", "0.9.5", "dist/inputs.min.js");
export const plot = dependency("@observablehq/plot", "0.2.2", "dist/plot.umd.min.js");
